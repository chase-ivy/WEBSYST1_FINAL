...
$loginUrl = htmlspecialchars(get_login_url(), ENT_QUOTES, 'UTF-8');
...
<body>
	...
	<!-- TOP NAV -->
	<div class="topbar">
		<a href="<?php echo $loginUrl; ?>" style="text-decoration:none; color:inherit;">
			<div class="topbar-logo" role="link" tabindex="0" aria-label="Go to login">
