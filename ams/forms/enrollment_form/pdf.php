...
$data = [
    ...
    '4ps_benificiary' => !empty($student['4p_benificiary']) ? 'Yes' : '',
    ...
    'municipality_city' => $current['municipality_city'],
    'province' => $current['province'],
    'country' => $current['country'],
    'zip_code' => $current['zip_code'],

    'house_nop' => $permanent['house_no'],
    'street_namep' => $permanent['street_name'],
    'barangayp' => $permanent['barangay'],
    'municipality_cityp' => $permanent['municipality_city'],
    'provincep' => $permanent['province'],
    'countryp' => $permanent['country'],
    'zip_codep' => $permanent['zip_code'],

    'father_last_name' => $parents['father_last_name'],
    'father_first_name' => $parents['father_first_name'],
    'father_middle_name' => $parents['father_middle_name'],
    'father_contact_number' => $parents['father_contact_number'],

    'mother_last_name' => $parents['mother_last_name'],
    'mother_first_name' => $parents['mother_first_name'],
    'mother_middle_name' => $parents['mother_middle_name'],
    'mother_contact_number' => $parents['mother_contact_number'],

    'guardian_last_name' => $parents['guardian_last_name'],
    'guardian_first_name' => $parents['guardian_first_name'],
    'guardian_middle_name' => $parents['guardian_middle_name'],
    'guardian_contact_number' => $parents['guardian_contact_number'],

    'last_grade_level_completed' => $returning_formattedGrade,
    'last_school_attended' => $returning_learner['last_school_attended'],
